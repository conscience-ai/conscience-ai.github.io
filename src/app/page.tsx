    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative -mt-32 z-10 px-6 pb-20">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <h1 className="text-5xl md:text-7xl font-light tracking-wide text-white font-heading">
            Advancing Intelligence
          </h1>
          
          <div className="space-y-6 text-lg md:text-xl leading-relaxed text-white max-w-3xl mx-auto">
            <p>
            ...
            <p className="text-base">
              — <a 
                ...
                className="text-orange-400 hover:text-blue-400 transition-colors"
                target="_blank"
